...
export default function Nav() {
  ...
  return (
    <nav className="bg-black bg-opacity-30 w-max block px-7 py-2.5 z-10 fixed left-1/2 transform -translate-x-1/2 bottom-10 flex gap-3 rounded-full backdrop-blur-lg">
